...
const SupervisorCard = ({ supervisor }) => {
  return (
    <div className="bg-white shadow-lg rounded-2xl p-6 w-100 hover:scale-105 transition">
        ...
        <img src={supervisor.photoLink} alt={supervisor.userName} className="w-72 h-72 rounded-full object-cover mb-4"/>
        </div>
      <h2 className="text-xl font-bold text-gray-800 mb-2">{supervisor.userName}</h2>
